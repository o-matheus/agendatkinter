...
cb_categoria = ttk.Combobox(janela, values=categorias, width= 25, font="Tahoma 14" )
cb_categoria.grid(row=2, column=1)


# TODO Combobox categoria vai ser adicionado aqui
...
# Criando a açâo/bind para quando o usuário clicar num contato da tabela
